...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-na.myconnectwise.net/v4_6_release/apis/3.0';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/3.0.0-beta/php";
    ...
    {
        $report  = 'PHP SDK (Spinen\ConnectWise\Clients\Time) Debug Report:' . PHP_EOL;
